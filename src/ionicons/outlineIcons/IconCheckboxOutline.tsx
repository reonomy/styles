...
export default function IconCheckboxOutline(props: SvgIconProps) {
  return (
    <SvgIcon viewBox="0 0 24 24" fill="none" {...props}>
      ...
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M5.25 2.25C3.59315 2.25 2.25 3.59315 2.25 5.25V18.75C2.25 20.4069 3.59315 21.75 5.25 21.75H18.75C20.4069 21.75 21.75 20.4069 21.75 18.75V5.25C21.75 3.59315 20.4069 2.25 18.75 2.25H5.25ZM3.75 5.25C3.75 4.42157 4.42157 3.75 5.25 3.75H18.75C19.5784 3.75 20.25 4.42157 20.25 5.25V18.75C20.25 19.5784 19.5784 20.25 18.75 20.25H5.25C4.42157 20.25 3.75 19.5784 3.75 18.75V5.25Z"
        fill="black"
        fillOpacity="0.54"
      />
    </SvgIcon>
